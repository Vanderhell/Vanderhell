...
## 🧱 loxdust — Verified persistent object storage for embedded systems

[`loxdust`](https://github.com/Vanderhell/loxdust) is a portable **C99** library for verified persistent object storage.
...
- caller-owned context and work memory
- fixed-width canonical on-disk encoding
- deterministic object registration and layout
- explicit format, mount, propose, verified read, check, repair, and confirm operations
- FAST, SAFE, and CRITICAL operating profiles
- RAM and file backends for host-side validation
...
## 🔀 loxsort — Constraint-aware deterministic sorting for embedded systems

[`loxsort`](https://github.com/Vanderhell/loxsort) is an experimental **C99** sorting library for embedded and resource-constrained systems.

It selects an algorithm using explicit constraints instead of relying on one fixed strategy:

- input size
- stability requirements
- available scratch memory
...
- deterministic policy-driven dispatcher
- stateless public API
- explicit result and dispatch information
- offline benchmark and profile-generation pipeline
- test coverage for algorithms, stability, dispatch, and profile logic
...
| [loxdust](https://github.com/Vanderhell/loxdust) | Verified persistent object storage with canonical encoding, deterministic layout, recovery operations, and power-cut-oriented validation. | C99 |
...
| [loxsort](https://github.com/Vanderhell/loxsort) | Experimental deterministic sorting library with constraint-aware algorithm dispatch and offline benchmark profiles. | C99 |
...
| [micronet](https://github.com/Vanderhell/micronet) | LAN-first messaging library for embedded nodes and desktop diagnostics, with peers, groups, data operations, custom traffic, and portable HAL adapters. | C99 |
...
## 🌐 micronet — LAN messaging for embedded nodes and desktop diagnostics

[`micronet`](https://github.com/Vanderhell/micronet) is a **C99 LAN messaging library** for embedded nodes and desktop diagnostic tools.
...
- explicit peer management
- groups and group membership
- publish, update, request, subscribe, and query operations
- custom peer, group, and broadcast traffic
- registered custom handlers
- runtime metrics
- portable HAL boundaries
- ESP32, Arduino, and desktop examples
...
- [`micronet`](https://github.com/Vanderhell/micronet) — LAN-first C99 messaging library for embedded nodes and desktop diagnostics.
